    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <div className="fixed bottom-[max(3.25rem,calc(env(safe-area-inset-bottom)+2.75rem))] right-[max(1.5rem,env(safe-area-inset-right))] z-50">
            <WhatsAppButton
              ...
              className="rounded-none w-14 h-14 p-0 shadow-lg hover:shadow-xl transition-shadow bg-kernel hover:bg-icefield text-chamber"
            >
