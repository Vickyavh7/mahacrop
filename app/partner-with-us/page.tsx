...
export default function PartnerWithUsPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Navigation />
      <main className="container mx-auto px-6 py-20 pt-32 border border-gray-200 rounded-lg mt-8">
        {" "}
        {/* Added border and rounded-lg, adjusted mt */}
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-green-800 mb-4">Partner With Us</h1>
